...
export default function Header() {
  ...
  return (
    <div
      className={`fixed top-0 left-0 right-0 w-full z-[1000] transition-translate ease-in-out duration-[350ms] ${
        scrollDirection == "down" ? "translate-y-[-100px]" : "translate-y-[0]"
      }`}
    >
                  ...
                  <li className="block relative z-10">
                    ...
                    >
                      <div className="relative">
                        ...
                        <span
                          className={`absolute top-0 left-0 mt-[0px] lg:mt-[3px] xl:mt-[3px] 2xl:mt-[3px] md:translate-x-[-20px] lg:translate-x-[-16px] xl:translate-x-[-19px] 2xl:translate-x-[-22px] w-[8px] h-[8px] xl:w-[9px] xl:h-[9px] 2xl:w-[10px] 2xl:h-[10px] rounded-full bg-black group-hover:opacity-100 group-focus:opacity-100 opacity-0`}
                        ></span>
                      </div>
                    </a>
                  </li>
