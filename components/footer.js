          ...
          <div className="w-full mt-auto">
            <div className="flex space-x-6 md:space-x-0 md:block">
              <div className="w-[47.5%] md:w-[165px] mb-6">
                <a
                  href="https://apps.apple.com/us/developer/homa-games/id1508492426"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full hover:opacity-75 focus:opacity-75"
                >
              ...
              <div className="w-[52.5%] md:w-[165px] mb-6">
                <a
                  href="https://play.google.com/store/apps/dev?id=4656343638685426415&hl=en&gl=US"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full hover:opacity-75 focus:opacity-75"
                >
            ...
            <div className="w-full 2xl:space-x-8 hidden md:flex md:flex-wrap">
              <a
                ...
                className="w-full 2xl:w-auto mb-1 2xl:mb-0 text-white/40 block hover:opacity-75 focus:opacity-75"
              >
                {contact.email}
              </a>
              <a
              ...
              <Link href="/privacy">
                <a className="w-full 2xl:w-auto mb-1 2xl:mb-0 text-white/40 block 2xl:mr-6 hover:opacity-75 focus:opacity-75">
                  Privacy
                </a>
              </Link>
              <Link href="/terms">
                <a className="w-full 2xl:w-auto mb-1 2xl:mb-0 text-white/40 block hover:opacity-75 focus:opacity-75">
                  Terms
                </a>
              </Link>
            </div>
        ...
        <div className="col-span-5 md:col-span-7 lg:col-span-6 xl:col-span-6 2xl:col-span-5 3xl:col-span-4 md:col-start-6 lg:col-start-7 xl:col-start-7 2xl:col-start-8 3xl:col-start-9">
          <div className="flex flex-wrap">
            ...
            <div className="w-full md:w-1/2 lg:w-auto text-sm md:text-base mb-16 md:mb-0 ml-auto order-1 md:order-2">
              <span className="block uppercase text-xs xl:text-base font-medium tracking-widest leading-none xl:leading-none mb-4 md:mb-6 xl:mb-8">
              ...
              <ul className="w-full mb-10 md:mb-16 xl:mb-24 flex flex-wrap md:block md:flex-none">
                <li className="block mb-4 md:mb-6 xl:mb-8">
                  ...
                  >
                    ...
                    <span className="hidden md:block break-all">
                      /homagames
                    </span>
                  </a>
                </li>
      ...
      <div className="grid grid-cols-5 md:grid-cols-12">
        <div className="col-span-5 block md:hidden mt-32 md:mt-0">
          ...
          <div className="w-full 2xl:space-x-8">
            <a
              href="mailto:bonjour@homagames.com"
              className="w-full 2xl:w-auto text-white/40 block mb-2 hover:opacity-75 focus:opacity-75"
            >
              bonjour@homagames.com
            </a>
            <a
              href="tel:+33142861324"
              className="w-full 2xl:w-auto text-white/40 block mb-2 hover:opacity-75 focus:opacity-75"
            >
              +33 1 42 86 13 24
            </a>
            <Link href="/privacy">
              <a className="w-full 2xl:w-auto text-white/40 block mb-2 2xl:mr-6">
                Privacy
              </a>
            </Link>
            <Link href="/terms">
